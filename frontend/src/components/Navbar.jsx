...
const Navbar = () => {
  ...
  const handleCreditsClick = () => {
    navigate("/buy-credits");  // Navigate to /buy-credits when clicked
  };

  const handleHomeClick = () => {
    navigate("/");  // Navigate to /buy-credits when clicked
  };

  return (
    <nav className="fixed top-0 left-0 z-50 w-full shadow-md bg-gradient-to-r from-white via-cyan-50 to-cyan-200">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4 text-sm sm:text-base md:text-lg lg:text-xl font-bold text-gray-700">
            {user ? (
              <>
                <button
                  onClick={handleCreditsClick}  // Add onClick event to trigger navigation
                ...
                <div className="relative">
                  ...
                  {showDropdown && (
                    ...
                    >
                      <button
                        className="w-full px-6 py-2 text-left hover:bg-cyan-100"
